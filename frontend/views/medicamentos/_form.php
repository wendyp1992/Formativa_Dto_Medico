...
<div class="medicamentos-form">
    <div class="row">
        ...
        <div class="col-md-4">
            <?=
            $form->field($model, 'tipo_med')->dropDownList(['ANTIBIOTICOS' => 'ANTIBIOTICOS', 'AMINOGLUCOSIDOS' => 'AMINOGLUCOSIDOS', 'ANESTESICOS' => 'ANESTESICOS',
                'Divorciado' => 'Divorciado/a', 'Union Libre' => 'Unión Libre'], ['maxlength' => true, 'style' => 'width:150px'])
            ?></div>
        <div class="col-md-4">
            <?=
